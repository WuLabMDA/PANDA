...
The benchmarking results on the simulated, cancer cell line and the TCGA multi-omics datasets can be obtained by running the corresponding code in the `./code/` folder.
